...
CREATE TABLE `admin_menu`  (
  ...
  `created_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  `menu_class` char(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL COMMENT '菜单的类名,如caidan1().无用无用',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `casbin_rule`  (
  ...
  INDEX `IDX_casbin_rule_EXISTS`(`ptype` ASC, `v0` ASC, `v1` ASC, `v2` ASC, `v3` ASC, `v4` ASC, `v5` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '管理后台权限规则.ptype的列:p填写权限,g为用户具备的角色.\r\n表格中的规则就是按照.角色是admin或user,权限对应表中的v1,也就是菜单的url.这里要说明的是,这里不写url也是可以的,只要能够唯一表示菜单页面的标识就行,且这个标识要与admin_menu表中的menu_url对应即可.访问规则是post/get等.此表只写入二级菜单即可,一级菜单只是一个提示作用,真正的控制权限是二级菜单哦.' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `casbin_rule` VALUES ('p', 'user', '/admin/wzgl', 'post', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', 'user', '/admin/wzgl', 'post', '', '', '');
...
INSERT INTO `casbin_rule` VALUES ('p', 'user', '/admin/zpgl', 'post', '', '', '');
INSERT INTO `casbin_rule` VALUES ('p', 'user', '/admin/zpgl', 'post', '', '', '');
...
CREATE TABLE `job_gangwei`  (
  ...
  `updated_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '岗位' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ren_cai_zhao_pin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 151 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '人才招聘' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user`  (
  ...
  `touxiang` varchar(80) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '头像',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1083 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1062, 'youxue', 'jinjin1984', '123@qq.com', '辽宁义县', '管理员', '15112345678', '19840318', '0', '男', '签名', '', '', 'http://127.0.0.1:8199/upload_file/ac32d93e-1fa7-4559-b658-104b1bc68803.jpg', 0000000000, b'1', 0, b'1', 0, '2023-06-23 16:14:56', '2025-08-23 13:17:37');
...
INSERT INTO `user` VALUES (1075, 'youxue1', 'jinjin1984', '1@q.co', '锦州义县', 'jinjin1', '15112345678', '19840318', '0', '男', '', '', '', 'upload_file/1c3c4473-179e-4af4-955e-7ec7687a7820.png', 0000000000, b'0', 0, b'1', 0, '2023-06-23 16:14:56', '2025-02-19 13:13:37');
INSERT INTO `user` VALUES (1076, 'youxue5', 'youxue5', 'youxue5@q.com', '', 'youxue5', '12345678901', '', '', '', '', '', '', 'http://127.0.0.1:8199/upload_file/3c4965df-0230-4e36-a916-be79d4d1c6d4.jpg', 0000000000, b'0', 0, b'0', 0, '2024-06-22 11:46:04', '2024-06-22 11:46:04');
INSERT INTO `user` VALUES (1077, 'youxue6', 'youxue6', 'youxue6@qq.com', '', 'youxue6', '12345678901', '', '', '', '', '', '', 'http://127.0.0.1:8199/upload_file/3c4965df-0230-4e36-a916-be79d4d1c6d4.jpg', 0000000000, b'0', 0, b'1', 0, '2024-06-22 11:57:31', '2025-02-18 16:24:26');
INSERT INTO `user` VALUES (1078, 'youxue7', 'youxue7', 'werwe@', '23456', 'youxue7', '12345678901', '', '', '', '', '', '', 'http://127.0.0.1:8199/upload_file/3c4965df-0230-4e36-a916-be79d4d1c6d4.jpg', 0000000000, b'0', 0, b'1', 0, '2024-06-22 12:03:48', '2025-02-18 16:24:06');
INSERT INTO `user` VALUES (1079, 'youxue8', 'youxue8', '76@qq.com', '', 'youxue8', '15412345678', '', '', '', '', '', '', '', 0000000000, b'0', 0, b'0', 0, '2025-02-18 17:15:19', '2025-02-18 17:15:19');
INSERT INTO `user` VALUES (1080, 'youxue9', 'youxue9', '1@qq.com', '', 'youxue9', '15212345678', '', '', '', '', '', '', '', 0000000000, b'0', 0, b'1', 0, '2025-02-18 17:25:01', '2025-02-18 17:25:01');
INSERT INTO `user` VALUES (1081, 'youxue10', 'youxue8', '28@qq.com', '', '我试试是地方', '15112345678', '', '', '', '', '', '', '127.0.0.1:8199', 0000000000, b'0', 0, b'1', 0, '2025-02-19 09:54:15', '2025-02-19 09:54:15');
INSERT INTO `user` VALUES (1082, 'youxue11', 'youxue11', '1@q.com', '', 'youxue11', '15112345678', '', '', '', '', '', '', '127.0.0.1:8199/upload_file/syspic/avatar.jpg', 0000000000, b'0', 0, b'1', 0, '2025-02-19 10:01:06', '2025-02-19 10:01:06');
...
CREATE TABLE `user_menu`  (
  ...
  `created_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  `updated_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入'
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '用户菜单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `wen_zhang`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `riqi`(`created_at` ASC, `fenleiid` ASC) USING BTREE,
  INDEX `aa`(`fenleiid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 258 CHARACTER SET = utf8 COLLATE = utf8_unicode_ci COMMENT = '文章' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `wen_zhang` VALUES (252, '20250329', '管理员', '20250329', 'thumbnail.png', '[{\"insert\":\"r\"},{\"insert\":\"trtr\",\"attributes\":{\"bold\":true,\"italic\":true,\"underline\":true}},{\"insert\":\"t\"},{\"insert\":\"\\n\",\"attributes\":{\"header\":1}}]', 0, 0, 1, '0', '0', b'0', '2025-03-29 11:18:15', '2025-03-29 11:18:15');
...
CREATE TABLE `zhao_pin_gong_si`  (
  ...
  `updated_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '招聘功能中的公司简介' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `zhaopin_fenlei_gangwei`  (
  ...
  `updated_at` datetime NULL DEFAULT NULL COMMENT '只需定义字段即可.gf自动填入',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '招聘的分类和岗位细分' ROW_FORMAT = DYNAMIC;
