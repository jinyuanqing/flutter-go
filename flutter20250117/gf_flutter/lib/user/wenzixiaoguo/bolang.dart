...
class Bolang_text extends StatefulWidget {
  const Bolang_text({Key? key}) : super(key: key);

  @override
  State<Bolang_text> createState() => _Bolang_textState();
}

class _Bolang_textState extends State<Bolang_text> with SingleTickerProviderStateMixin {
            ...
            return Container(
              ...
              child: CustomPaint(
                painter: CircleTextPainter(
                  ...
                  yPos: sin(_xAnimation.value * 2 * pi) * 0.5 + 0.5,
