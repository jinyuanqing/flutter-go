...
class CircleTextEffect extends StatefulWidget {
  const CircleTextEffect({Key? key}) : super(key: key);

  @override
  State<CircleTextEffect> createState() => _CircleTextEffectState();
}

class _CircleTextEffectState extends State<CircleTextEffect> with SingleTickerProviderStateMixin {
