...
import '/global.dart';import 'package:get/get.dart' as Get;
//编辑器
...
import '/admin/edtor/widgets/demo-scaffold.dart';
  import '/user/gongsijianjie/company.dart';

// 文章详情页
// ignore: camel_case_types
class Zhaopin_xiangqing extends StatefulWidget {
  final id;
  final gong_si_ming;
  final gangwei;
  final xueli;
  ...
  @override
  State<StatefulWidget> createState() => new _Zhaopin_xiangqing();
}

// ignore: camel_case_types
class _Zhaopin_xiangqing extends State<Zhaopin_xiangqing> {
  //class _Zhaopin_xiangqing extends StatelessWidget{
  //final title;final nei_rong; final id;final zuo_zhe;final ri_qi;
  // _Zhaopin_xiangqing({Key key, @required this.title,@required this.nei_rong,@required this.id,@required this.zuo_zhe,@required this.ri_qi}): super(key: key);//注意这是需要参数的类的定义,继承自StatelessWidget
                                            ...
                                            Flexible(
                                                ...
                                                child: Column(
                                                  children: [
                                                    ...
                                                    Get.Get.to(Company(id: 1, gong_si_ming: gong_si_ming, tupian: list_companypic));
                                                      },
                                                    ),
