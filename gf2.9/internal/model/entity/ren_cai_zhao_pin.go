...
// RenCaiZhaoPin is the golang structure for table ren_cai_zhao_pin.
type RenCaiZhaoPin struct {
	...
	Baoxian         string      `json:"baoxian"         description:"包括:五险一金,包吃, 加班补助 包住 饭补 交通补助 年底双薪 周末双休"`
	...
	Qita            string      `json:"qita"            description:"其他,备用"`
	...
	Tupian          string      `json:"tupian"          description:"图片json"`
	Zuozhe          string      `json:"zuozhe"          description:"发布者"`
	Zhiding         string      `json:"zhiding"         description:"置顶,默认字符串0"`
	Jinghua         string      `json:"jinghua"         description:"精华,默认字符串0"`
}
